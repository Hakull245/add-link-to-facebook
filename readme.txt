...
* Vietnamese (vi\_VN) by [](http:// ""), thanks!
* Your translation ...
...
* Added Vietnamese (vi\_VN) translation by [](http:// "")
...
= 1.33 =
* Bugfix: avatar gone after editing copied comment
* Improvement: check argument foreach
* Updated Norwegian (nb\_NO) translation by [Stein Ivar Johnsen](http://www.idyrøy.no/ "Stein Ivar Johnsen")

= 1.32 =
* New feature: clear error messages
* Updated Dutch (nl\_NL) and Flemish (nl\_BE) translations

= 1.31 =
* New feature: sidebar widget for like/send button
...
= 1.29 =
* New feature: copy Facebook comments into WordPress database
* Bugfix: correct comment count
* Updated Dutch (nl\_NL) and Flemish (nl\_BE) translations
* Updated Norwegian (nb\_NO) translation by [Stein Ivar Johnsen](http://www.idyrøy.no/ "Stein Ivar Johnsen")
...
* Improvement: truncate first sentence if too long
* Improvement: use default picture for OGP if no link picture
* Improvement: removed OGP picture for frontpage
* Updated FAQ
* Updated Dutch (nl\_NL) and Flemish (nl\_BE) translations
* Updated German (de\_DE) translation by [Björn](http://cooleisbaer.co.funpic.de/ "Björn")
* Updated Italian (it\_IT) translation by [Gianni](http://gidibao.net/ "Gianni")
...
* Improvement: extended debug information with settings version
* Bugfix: input type text
* Bugfix: multiple settings version upgrade
* Updated Dutch (nl\_NL) and Flemish (nl\_BE) translations
* Updated Norwegian (nb\_NO) translation by [Stein Ivar Johnsen](http://www.idyrøy.no/ "Stein Ivar Johnsen")
...
= 1.29 =
One new feature, one bugfix, translation update
