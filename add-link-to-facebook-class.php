...
?>
			...
			<tr valign="top"><th scope="row">
				...
				<input class="al2fb_trailer" id="al2fb_trailer" name="<?php echo c_al2fb_meta_trailer; ?>" text="text" value="<?php  echo get_user_meta($user_ID, c_al2fb_meta_trailer, true); ?>" />
